...
const createNoteFooter = (priority) => {
  ...
  noteSection1.appendChild(createActionButton('expand_more', ICON_TYPES.DECREASE_PRIORITY));

  noteSection1.appendChild(createActionButton('expand_less', ICON_TYPES.INCREASE_PRIORITY));
